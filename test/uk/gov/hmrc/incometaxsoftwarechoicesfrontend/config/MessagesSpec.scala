...
class MessagesSpec extends PlaySpec with MessagesMatcher {
  override val excludedKeys: Set[String] = Set(
    ...
    "product-details.income-and-deduction-types.construction-industry-scheme.para",
    "product-details.income-and-deduction-types.lloyds-underwriters.para",
    "product-details.income-and-deduction-types.marriage-allowance.para",
    "product-details.income-and-deduction-types.heading.para",
    "product-details.income-and-deduction-types.minister-of-religion.para",
    "product-details.income-and-deduction-types.capital-gains-tax.para",
    "product-details.income-and-deduction-types.partner-income.para",
    "product-details.income-and-deduction-types.complex-partnerships.para",
    "product-details.income-and-deduction-types.state-pension.para",
    "product-details.income-and-deduction-types.member-of-parliament.para",
    "product-details.income-and-deduction-types.paye.para",
    "product-details.income-and-deduction-types.investments.para",
    "product-details.income-and-deduction-types.residence-and-remittance.para",
    "product-details.income-and-deduction-types.uk-dividends.para",
    "product-details.income-and-deduction-types.sa-additional-income.para",
    "product-details.income-and-deduction-types.property-business.para",
    "product-details.income-and-deduction-types.married-allowance.para",
    "product-details.income-and-deduction-types.gift-aid.para",
    "product-details.income-and-deduction-types.blind-persons-allowance.para",
    "product-details.income-and-deduction-types.simple-partnerships.para",
    "product-details.income-and-deduction-types.student-loans.para",
    "product-details.income-and-deduction-types.pensions.para",
    "product-details.income-and-deduction-types.pension-contributions.para",
    "product-details.income-and-deduction-types.uk-interest.para",
    "product-details.income-and-deduction-types.employment.para",
    "product-details.income-and-deduction-types.foreign-income.para",
    "product-details.income-and-deduction-types.self-employment.para",
    "product-details.income-and-deduction-types.high-income-child-benefit.para",
    "product-details.income-and-deduction-types.number-covered",
    "product-details.income-and-deduction-types.link",
